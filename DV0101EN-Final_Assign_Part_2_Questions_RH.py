...
# Reader please note: This code does not work properly. It does not render graphs for the Recession Years statistics
...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            # style = {'width': 80%, 'padding': 3, 'font-size' : 20, 'textAlign-last': 'center'}
        )
    ]),
    html.Div([
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
                            figure=px.pie(values=exp_rec['Advertising_Expenditure'],
                            names=exp_rec['Vehicle_Type'],
                            title='Total Advertising Expenditure by Vehicle type during recessions')
                            )

# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_sales=recession_data.groupby(['Unemployment_Rate','Vehicle_Type'])['Automobile_Sales']
        R_chart4 =dcc.Graph(
                            figure=px.bar(x=unemp_sales['Unemployment_Rate'],
                                          y=unemp_sales['Automobile_Sales'],
                                          color=unemp_sales['Vehicle_Type'],
                                          title="Automobile Sales by Unemployment Rate and Vehicle type during recessions")
        )
